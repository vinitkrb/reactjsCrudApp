    ...
    return (
      <div>
        ...
        <h2 style={{ paddingLeft: 95 + 'em', fontSize: 13 + 'px' }} >{this.state.date.toLocaleTimeString()}.</h2>
          ...
          <input placeholder="Enter first name" className="" type="text" value={this.state.firstName} onChange={this.handleFirstNameChange} required /><br/>
          <label>Last Name:</label>
          <input placeholder="Enter last name" type="text" value={this.state.lastName} onChange={this.handleLastNameChange} required /><br/>
          <label style={{ paddingRight: 17 + 'px' }}>Gender:</label>
          <select  className="styled-select rounded" value={this.state.gender} onChange={this.handleGender} >
          <option value="" disabled selected hidden>Choose a Gender</option>
            <option value="Male">Male</option>
            <option value="Female">Female</option>
            <option value="Transgender">Transgender</option>
          </select>
          <div style={{paddingLeft : 15 +'em',paddingTop : 2 +'em'}}>
